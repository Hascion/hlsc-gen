...
export interface HalscionInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface Halscion extends BaseContract {
  connect(runner?: ContractRunner | null): Halscion;
  waitForDeployment(): Promise<this>;

  interface: HalscionInterface;
  ...
  getCurrentReward: TypedContractMethod<
    [staker: AddressLike],
    [bigint],
    "view"
  >;

  getStake: TypedContractMethod<[staker: AddressLike], [bigint], "view">;
